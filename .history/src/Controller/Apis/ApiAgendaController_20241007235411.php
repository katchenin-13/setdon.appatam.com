...
class ApiCalendrierController extends ApiInterface
{



    #[Route('/', name: 'api_calendrier', methods: ['GET'])]
    public function getallheaders(EventRepository $eventRepository, StatsService $statsService): Response
    {
