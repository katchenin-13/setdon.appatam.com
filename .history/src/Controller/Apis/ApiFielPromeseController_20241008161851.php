...
class ApiFielPromeseController extends ApiInterface
{
    ...
    #[Route('/getOne/{id}', name: 'api_fielpromesse_get_one', methods: ['GET'])]


    #[Route('/justification_fielpromesse/{id}', name: 'api_fielpromesse_justification', methods: ['POST'])]
    #[OA\Tag(name: 'fielpromesse')]
    #[Security(name: 'Bearer')]
