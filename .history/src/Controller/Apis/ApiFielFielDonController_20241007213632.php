...
class ApiFieldonController extends ApiInterface
{
    ...
    public function getAll(FieldonRepository $demandeRepository): Response
    {
        try {
            $fieldons = $demandeRepository->findAll();
            $tabaFieldon = [];
            $i = 0;
    ...
    // public function justification(Request $request, FieldonRepository $demandeRepository, $id)
    // {
    //     try {
