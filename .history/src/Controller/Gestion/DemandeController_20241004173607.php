...
class AudienceController extends BaseController
{
    ...
    public function edit(Request $request, Denande $denande, AudienceRepository $audienceRepository, FormError $formError): Response
    {
        $form = $this->createForm(AudienceType::class, $denande, [
            'method' => 'POST',
            'etat' => 'create',
    ...
    public function justification(Request $request, Denande $denande, AudienceRepository $audienceRepository, FormError $formError): Response
    {
    ...
    public function delete(Request $request, Denande $denande, AudienceRepository $audienceRepository): Response
    {
    ...
    public function workflow(Request $request, Denande $denande, AudienceRepository $audienceRepository, FormError $formError): Response
    {
